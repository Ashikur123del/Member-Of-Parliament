...
const faqs: FAQItem[] = [
  {
    ...
    answer:
      "আমাদের নিজস্ব প্রকৌশলী টিম এবং স্থানীয় নাগরিক কমিটির যৌথ অংশগ্রহণে প্রতি মাসে মাঠপর্যায়ে কাজের অগ্রগতি পরিদর্শন ও মূল্যায়ন করা হয়।",
  },
  {
    question: "নতুন কোনো প্রকল্পের জন্য নাগরিকরা কীভাবে প্রস্তাব পাঠাতে পারেন?",
    answer:
      "আমাদের ওয়েবসাইটের 'নতুন প্রকল্পের প্রস্তাবনা দিন' ফর্মটির মাধ্যমে যে কেউ তাদের এলাকার প্রয়োজন বা যেকোনো উন্নয়নমূলক কাজের জন্য প্রস্তাব সরাসরি পাঠাতে পারেন।",
  },
  {
    question: "প্রকল্পের বাজেট ও অর্থায়ন উৎস কীভাবে জানা যাবে?",
    answer:
      "প্রতিটি প্রকল্পের অর্থায়ন স্বচ্ছ রাখার জন্য বার্ষিক উন্নয়ন প্রতিবেদন প্রকাশ করা হয় এবং স্ব-স্ব এলাকার প্রধান কেন্দ্রে তা সর্বসাধারণের জন্য উন্মুক্ত থাকে।",
  },
  {
    question:
      "প্রকল্প বাস্তবায়নে কোনো সমস্যা বা অনিয়ম দেখলে কীভাবে অভিযোগ করবো?",
    answer:
      "আমাদের সিটিজেন হেল্পলাইন নম্বর অথবা সরাসরি কন্টাক্ট পেজের মাধ্যমে যেকোনো অনিয়ম বা ধীরগতির অভিযোগ প্রমাণসহ জমা দেওয়া সম্ভব।",
  },
  {
    question: "পরিকল্পিত প্রকল্পগুলোর কাজ কখন শুরু হবে?",
    answer:
      "বাজেট অনুমোদন এবং প্রাথমিক প্রশাসনিক প্রক্রিয়াকরণ সম্পন্ন হওয়ার সাথে সাথেই প্রস্তাবিত প্রকল্পগুলোর কাজ শুরু করার সঠিক তারিখ বিজ্ঞপ্তির মাধ্যমে জানিয়ে দেওয়া হয়।",
  },
];
        ...
        {faqs.map((faq, index) => {
          ...
          return (
            ...
            >
              ...
              >
                <span className="leading-snug pr-1 select-none">
                  {faq.question}
                </span>
