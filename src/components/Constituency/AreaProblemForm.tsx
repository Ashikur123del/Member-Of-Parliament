      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-8 space-y-2">
          ...
          <p className="text-xs font-semibold sm:text-sm text-[var(--text-2)]">
            রাস্তাঘাট, ড্রেনেজ বা এলাকার নিরাপত্তা সংক্রান্ত তথ্য আমাদের টিমকে
            জানান
          </p>
        </div>
        ...
        <form
          ...
          className="p-6 sm:p-8 rounded-2xl bg-[var(--surface-2)] border border-[var(--border)] space-y-4 shadow-sm"
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              >
                ...
                <option value="নিরাপত্তা ও আইনশৃঙ্খলা">
