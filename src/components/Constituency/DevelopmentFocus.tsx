  ...
  const priorities: PriorityItem[] = [
    {
      ...
      icon: FiTruck,
      image: N1,
      points: ["স্মার্ট ট্রাফিক কন্ট্রোল সিস্টেম", "বাইপাইল মোড়ে আধুনিক ফ্লাইওভার", "পথচারীদের জন্য নিরাপদ ওভারব্রিজ"],
    },
    {
      ...
      icon: FiDroplet,
      image: N2,
      points: ["বংশাই ও তুরাগ নদীর সীমানা নির্ধারণ", "আধুনিক বর্জ্য শোধনাগার (STP)", "খাল পুনঃখনন ও ড্রেন পরিষ্কার"],
    },
    {
      ...
      icon: FiHeart,
      image: N3,
      points: ["শ্রমিকদের জন্য বিশেষায়িত হেলথ কার্ড", "উপজেলা হাসপাতালে শয্যা সংখ্যা বৃদ্ধি", "২৪/৭ ফ্রি অ্যাম্বুলেন্স সেবা"],
    },
    {
      ...
      icon: FiShield,
      image: N4,
      points: ["পুরো এলাকা স্মার্ট সিসিটিভির আওতায়", "চাঁদাবাজ ও কিশোর গ্যাংদের বিরুদ্ধে কঠোর ব্যবস্থা", "কমিউনিটি পুলিশিং জোরদার"],
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-20 space-y-2  md:space-y-4">
          ...
          <p className="text-base sm:text-lg text-[var(--text-2)] font-medium  md:font-semibold leading-relaxed">
            সাভার ও আশুলিয়াবাসীর দীর্ঘদিনের নাগরিক দুর্ভোগ দূরীকরণ এবং আধুনিক উপশহর গড়ে তুলতে আমাদের সুনির্দিষ্ট ও বাস্তবমুখী পরিকল্পনা।
          </p>
        </div>
