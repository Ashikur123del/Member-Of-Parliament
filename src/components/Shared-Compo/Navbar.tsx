    ...
    <header className="sticky top-0 z-50 w-full bg-[var(--surface)]/95 backdrop-blur-md border-b border-[var(--border)] transition-all">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20 relative gap-2 sm:gap-4">
          ...
          >
            <div className="relative w-12 h-12 sm:w-16 sm:h-16 rounded-full overflow-hidden border-2 border-[var(--primary)] shadow-md group-hover:scale-105 transition-transform shrink-0">
              <Image 
                src={Image5} 
            ...
            <div className="flex flex-col">
              <span className="font-extrabold text-sm sm:text-lg leading-tight tracking-tight text-[var(--text)] group-hover:text-[var(--primary)] transition-colors whitespace-nowrap">
                দেওয়ান মঈনুদ্দিন বিপ্লব
              </span>
              <span className="text-[10px] sm:text-xs font-medium text-[var(--text-2)] leading-tight whitespace-nowrap">
