...
export const VideoNewsSection = () => {
  ...
  const videoNewsList: VideoNews[] = [
    ...
    },
    {
      ...
      title: "আশুলিয়া শিল্পাঞ্চলের শ্রমিক স্বাস্থ্য সুরক্ষা ও মেডিকেল ক্যাম্প নিয়ে বার্তা",
      description:
    ...
    },
    {
      ...
      title: "আশুলিয়া নতুন ড্রেনেজ সিস্টেম ও জলাবদ্ধতা নিরসন প্রকল্পের ভিডিও ডকুমেন্টারি",
      description:
    ...
    },
    {
      ...
      title: "সাভার কেন্দ্রীয় মাঠে আয়োজিত বইমেলা ও সাংস্কৃতিক উৎসবের সরাসরি হাইলাইটস",
      description:
          ...
          >
            ...
            <div className="p-6 flex-1 flex flex-col justify-between space-y-3">
              ...
              <div className="pt-3 border-t border-[var(--border)] flex items-center justify-between">
                ...
                <span className="text-xs text-[var(--muted)]">এইচডি রিপোর্ট</span>
              </div>
            </div>
          </div>
        ))}
